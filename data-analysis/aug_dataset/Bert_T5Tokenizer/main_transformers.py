from transformers import T5Config, T5ForSequenceClassification, T5Tokenizer, BertConfig, BertForSequenceClassification
...
class MyModel(L.LightningModule):
    ...
    def forward(
        ...
        logits = self.model(input_ids=encoder_input, attention_mask=attention_mask, labels=labels.argmax(dim=-1))
