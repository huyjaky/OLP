...
class MyModel(L.LightningModule):
    def __init__(
        ...
        print('vocab size',self.src_tokenizer.get_vocab_size())
        ...
        self.tail = nn.Sequential(
            nn.Linear(self.input_dim * 2, self.tgt_tokenizer.get_vocab_size()),
        )  # 64x64x3000
    ...
    def validation_step(self, batch, batch_idx):
        ...
        for pred, target in zip(pred_id.argmax(dim=-1), target_id):
...
def train(model):
    model_name = "translation_olp_lstm"
